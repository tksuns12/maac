...
pub use compiler::{
    check, check_bundle, check_bundle_versioned, check_bundle_versioned_with_limits,
    check_bundle_with_limits, check_versioned, check_versioned_with_limits, check_with_limits,
    compile, compile_bundle, compile_bundle_versioned, compile_bundle_versioned_with_limits,
    compile_bundle_with_limits, compile_versioned, compile_versioned_with_limits,
    compile_with_limits,
};
pub use diagnostic::{Diagnostic, DiagnosticCode, Diagnostics, Span};
pub use dsp::{render, render_versioned, render_versioned_with_limits, render_with_limits};
...
pub use export::{
    render_wav_to_path_versioned, render_wav_to_path_versioned_with_limits, write_wav_versioned,
    write_wav_versioned_with_limits,
};
