...
preserve-pitch audio warping, executable external plug-in hosting and other extensions. Generic execution of unknown/external processors, notation/DAW adapters, GUI and real-time
