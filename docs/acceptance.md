...
| Plan import | Unknown versions/fields, inconsistent time/frame values, duplicates, missing references, invalid parameter ranges, same-sample cycles, oversized input and collections |
